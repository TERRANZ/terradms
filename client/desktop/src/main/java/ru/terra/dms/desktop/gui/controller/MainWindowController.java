    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        configuration.getMenus().forEach(menuPart -> {
            ...
            viewPartMenuItem.setOnAction(action -> {
                ...
                Pair<Stage, AbstractViewPart> windowPair = StageHelper.<AbstractViewPart>openWindow(ViewPartHelper.getInstance().getFXML(viewPart.getControllerType()), menuPart.getViewPart(), false);
