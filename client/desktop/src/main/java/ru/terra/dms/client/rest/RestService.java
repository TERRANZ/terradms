...
}, comments = "wadl2java, http://wadl.java.net", date = "2014-06-02T13:18:37.673+04:00")
public class RestService {
    ...
    public static class Objects {
        ...
        public RestService.Objects.DoGetJsonId doGetJsonId(Long id) {
        ...
        public RestService.Objects.DoDeleteJsonId doDeleteJsonId(Long id) {
        ...
        public static class DoCreateJson {
            ...
            public <T> T putXWwwFormUrlencodedAsJson(Object input, com.sun.jersey.api.client.GenericType<T> returnType) {
                ...
                if (response.getStatus() >= 400) {
                    throw new RestService.WebApplicationExceptionMessage(Response.status(response.getStatusInfo().getStatusCode()).build());
                }
        ...
        public static class DoDeleteJsonId {
             ...
             * Create new instance using existing Client instance, and a base URI and any parameters
             */
            public DoDeleteJsonId(com.sun.jersey.api.client.Client client, URI baseUri, Long id) {
                _client = client;
                _uriBuilder = UriBuilder.fromUri(baseUri);
             ...
             */
            public RestService.Objects.DoDeleteJsonId setId(Long id) {
        ...
        public static class DoGetJsonId {
             ...
             * Create new instance using existing Client instance, and a base URI and any parameters
             */
            public DoGetJsonId(com.sun.jersey.api.client.Client client, URI baseUri, Long id) {
                _client = client;
                _uriBuilder = UriBuilder.fromUri(baseUri);
             ...
             * Duplicate state and set id
             */
            public RestService.Objects.DoGetJsonId setId(Long id) {
                Map<String, Object> copyMap;
                copyMap = new HashMap<String, Object>(_templateAndMatrixParameterValues);
                UriBuilder copyUriBuilder = _uriBuilder.clone();
                copyMap.put("id", id);
